...
namespace GameObjectComponent
{
	...
	private:
		...
		float successReactionTimer_ = 0.0f;
		float lockOnRadiusNdc_ = 0.2f;
		static constexpr float kDefaultActivationAnimationDuration = 0.2f;
		static constexpr float kDefaultSuccessReactionDuration = 0.18f;
		static constexpr float kDefaultHitStopDuration = 0.08f;
		static constexpr float kDefaultWindUpArcRadians = -1.05f;
		static constexpr float kDefaultSwingArcRadians = 1.05f;
		static constexpr float kDefaultSuccessRecoilArcRadians = -0.15f;
		...
		float successReactionDuration_ = kDefaultSuccessReactionDuration;
		...
		float successRecoilArcRadians_ = kDefaultSuccessRecoilArcRadians;
